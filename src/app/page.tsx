    ...
    <main className="fe-scene bg-black overflow-y-auto sm:overflow-hidden !justify-start md:!justify-center !items-start">
      ...
      <section className="relative z-10 w-full max-w-4xl mx-auto px-6 pt-24 pb-12 md:py-32 flex flex-col items-center justify-center min-h-screen text-center">
        <div className="fe-flicker mb-8 md:mb-12">
           <div className="fe-hologram text-amber-500/60 mb-4 font-black text-[10px] md:text-xs">Local Area Network Active</div>
           <h1 className="text-[15vw] md:text-[8rem] font-black italic tracking-tighter text-white leading-[0.9] md:leading-none">
             FRACTURED<br/>
             <span className="text-amber-500">EARTH</span>
           </h1>
        </div>

        <p className="max-w-2xl text-base md:text-2xl text-white/50 font-light tracking-tight mb-12 md:mb-16 px-4 leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row gap-4 md:gap-6 w-full max-w-2xl mt-8 px-4">
           <Link href="/lan" className="fe-holo-btn flex-1 flex justify-center items-center !py-4 md:!py-5 text-base md:!text-lg !text-white !bg-amber-500/10 !border-amber-500/30 hover:!bg-amber-500/20">
             Start Protocol
           </Link>
           <Link href="/tutorial" className="fe-holo-btn flex-1 flex justify-center items-center !py-4 md:!py-5 text-base md:!text-lg">
             Training
           </Link>
           <Link href="/rules" className="fe-holo-btn flex-1 flex justify-center items-center !py-4 md:!py-5 text-base md:!text-lg !border-sky-500/50 !text-sky-400">
             NeuralAtlas
           </Link>
        </div>
